# Capestone-Project on CNN (Deep Learning)
...
In the source data, the image files in the train, test, and valid folders were not organized into separate directories based on their respective labels
